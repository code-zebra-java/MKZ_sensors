...
from mobileye_msgs.msg import MobileyeInfo
from mobileye_msgs.msg import ObstacleData
from mobileye_msgs.msg import LKAlane
from mobileye_msgs.msg import TSR

class mobileyeSub():
    def __init__(self):
        rclpy.init_node("dbw_mobileye_node")
        self.mobPub = rclpy.Publisher('/Mobileye_Info', MobileyeInfo, queue_size=20)
        self.frame_ok = 0
    ...
    def listener(self):
        rclpy.Subscriber("/received_messages", Frame, self.data_pub)
        rclpy.spin()
